...
const faqJsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      author: { '@id': `${SITE_URL}/federal-tax-brackets#author` },
      reviewedBy: { '@id': `${SITE_URL}/federal-tax-brackets#author` },
      publisher: { '@id': `${SITE_URL}/#organization` },
      breadcrumb: { '@id': `${SITE_URL}/federal-tax-brackets#breadcrumb` },
      mainEntity: { '@id': `${SITE_URL}/federal-tax-brackets#dataset` },
    },
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-xl border border-border/30 bg-card/50 p-5">
              ...
              <div className="space-y-2">
                {[
                  { href: '/paycheck-calculator', label: 'Paycheck Calculator (All States)' },
            ...
            <div className="rounded-xl border border-border/30 bg-card/50 p-5">
              <h3 className="text-base font-semibold text-foreground mb-3">Financial Calculators & Blog</h3>
              <div className="space-y-2">
                {[
