...
// ─── Study Data ──────────────────────────────────────────────────────────
// All six studies are defined here. The dynamic [slug] route uses
// generateStaticParams to pre-render each study at build time.
...
const STUDIES: Study[] = [
  {
    ...
    metaTitle: '2026 State Tax Burden Rankings — Income + Property + Sales Tax',
    metaDescription:
      'Total state tax burden (income + property + sales) for all 50 states in 2026. See which states have the highest and lowest effective tax burden, and how OBBBA changed the picture.',
    ...
    sections: [
      {
        heading: 'Methodology: How We Calculate Total Tax Burden',
        body:
      ...
      {
        heading: 'Top 10 Highest State Tax Burdens in 2026',
        body:
      ...
      {
        heading: 'Top 10 Lowest State Tax Burdens in 2026',
        body:
      ...
      {
        heading: 'How OBBBA Changed the Picture',
        body:
      ...
      {
        heading: 'Why State Tax Burden Matters',
        body:
    ...
    faqs: [
      {
        question: 'What is state tax burden?',
        answer:
      ...
      {
        question: 'Which state has the highest tax burden in 2026?',
        answer:
      ...
      {
        question: 'Which state has the lowest tax burden in 2026?',
        answer:
      ...
      {
        question: 'Does the OBBBA SALT cap change reduce state taxes?',
        answer:
      ...
      {
        question: 'How do you calculate the effective property tax rate?',
        answer:
      ...
      {
        question: 'How often is this study updated?',
        answer:
    ...
    datasets: [
      {
        name: '2026 State Income Tax Brackets — All 50 States',
        description:
          'Top marginal state income tax rate and standard deduction for each of the 50 states, for the 2026 tax year.',
        creator: 'TheTaxCalc',
        url: `${SITE_URL}/research/2026-state-tax-burden#income-tax-data`,
      },
      {
        name: '2026 Combined State and Local Sales Tax Rates',
        description:
          'State base sales tax rate plus average local add-on rate, weighted by population, for all 50 states.',
        creator: 'TheTaxCalc, sourced from Tax Foundation',
        url: `${SITE_URL}/research/2026-state-tax-burden#sales-tax-data`,
      },
      {
        name: '2026 Effective Property Tax Rates by State',
        description:
          'Median annual property tax bill divided by median home value, with state homeownership rate, for all 50 states.',
        creator: 'TheTaxCalc, sourced from U.S. Census Bureau ACS',
        url: `${SITE_URL}/research/2026-state-tax-burden#property-tax-data`,
      },
    ],
  },
  {
    ...
    metaTitle: 'Best States for Remote Workers 2026 — Tax-Adjusted Rankings',
    metaDescription:
    ...
    sections: [
      {
        heading: 'Methodology: The Remote Worker Index',
        body:
      ...
      {
        heading: 'Top 10 Best States for Remote Workers in 2026',
        body:
      ...
      {
        heading: 'Bottom 10 States for Remote Workers in 2026',
        body:
      ...
      {
        heading: 'How OBBBA Tip and Overtime Deductions Affect the Rankings',
        body:
      ...
      {
        heading: 'Considerations Beyond Taxes',
        body:
    ...
    faqs: [
      {
        question: 'Which state is best for remote workers in 2026?',
        answer:
      ...
      {
        question: 'How does OBBBA affect remote workers?',
        answer:
      ...
      {
        question: 'What is the convenience-of-the-employer rule?',
        answer:
      ...
      {
        question: 'Do remote workers have to pay taxes in multiple states?',
        answer:
      ...
      {
        question: 'How is the Remote Worker Index calculated?',
        answer:
      ...
      {
        question: 'Should I move to a no-income-tax state as a remote worker?',
        answer:
    ...
    datasets: [
      {
        name: '2026 Remote Worker Index Scores — All 50 States',
        description:
          'Composite 0-100 score and four sub-scores (after-tax income, cost of living, broadband, friendliness) for each state.',
        creator: 'TheTaxCalc',
        url: `${SITE_URL}/research/best-states-for-remote-workers-2026#index-data`,
      },
      {
        name: '2026 State Broadband Coverage at 100 Mbps+',
        description:
        ...
        creator: 'TheTaxCalc, sourced from FCC Broadband Deployment Report',
        url: `${SITE_URL}/research/best-states-for-remote-workers-2026#broadband-data`,
      },
      {
        name: '2026 State Cost of Living Index',
        description:
        ...
        creator: 'TheTaxCalc, sourced from C2ER',
        url: `${SITE_URL}/research/best-states-for-remote-workers-2026#col-data`,
      },
    ],
  },
  {
    ...
    metaTitle: 'Child Tax Credit Guide 2026 — $2,200 Per Child Under OBBBA',
    metaDescription:
      'Complete guide to the 2026 Child Tax Credit under OBBBA. $2,200 per qualifying child, $1,700 refundable, phaseout rules, and worked examples comparing OBBBA to prior law.',
    ...
    sections: [
      {
        heading: 'What Changed Under OBBBA',
        body:
      ...
      {
        heading: 'Eligibility: Who Qualifies as a "Child"?',
        body:
      ...
      {
        heading: 'Worked Example: Family of Four',
        body:
      ...
      {
        heading: 'How the CTC Interacts With Other OBBBA Provisions',
        body:
    ...
    faqs: [
      {
        question: 'How much is the Child Tax Credit in 2026?',
        answer:
      ...
      {
        question: 'What are the income limits for the Child Tax Credit in 2026?',
        answer:
      ...
      {
        question: 'Who qualifies as a "child" for the Child Tax Credit?',
        answer:
      ...
      {
        question: 'How is the 2026 CTC different from prior law?',
        answer:
      ...
      {
        question: 'How do I claim the Additional Child Tax Credit (refundable portion)?',
        answer:
      ...
      {
        question: 'Can I claim the Child Tax Credit if I have no income tax liability?',
        answer:
    ...
    datasets: [
      {
        name: '2026 Child Tax Credit Maximum and Refundable Amounts',
        description:
          'Maximum CTC, refundable ACTC, and phaseout thresholds for 2026 under OBBBA, with prior-law comparison.',
        creator: 'TheTaxCalc, sourced from IRS Publication 972 and OBBBA (P.L. 119-1)',
        url: `${SITE_URL}/research/child-tax-credit-guide-2026#amounts`,
      },
      {
        name: '2026 Child Tax Credit Phaseout Worksheet',
        description:
          'Step-by-step worksheet to calculate CTC reduction based on modified adjusted gross income for single and MFJ filers.',
        creator: 'TheTaxCalc',
        url: `${SITE_URL}/research/child-tax-credit-guide-2026#phaseout-worksheet`,
      },
      {
        name: '2026 CTC Worked Examples by Filing Status',
        description:
          'Six worked examples showing CTC calculation for single, MFJ, and head of household filers across income levels.',
        creator: 'TheTaxCalc',
        url: `${SITE_URL}/research/child-tax-credit-guide-2026#examples`,
      },
    ],
  },
  {
    ...
    metaTitle: 'Property Tax by State 2026 — Effective Rates and Median Bills',
    metaDescription:
      'Effective property tax rates and median annual property tax bills for all 50 states in 2026. From New Jersey (highest) to Hawaii (lowest), with county-level context and the OBBBA SALT cap impact.',
    ...
    sections: [
      {
        heading: 'Methodology: Effective Rate vs Nominal Rate',
        body:
      ...
      {
        heading: 'Top 10 Highest Property Tax States in 2026',
        body:
      ...
      {
        heading: 'Top 10 Lowest Property Tax States in 2026',
        body:
    ...
    faqs: [
      {
        question: 'Which state has the highest property taxes in 2026?',
        answer:
      ...
      {
        question: 'Which state has the lowest property taxes in 2026?',
        answer:
      ...
      {
        question: 'How does the OBBBA SALT cap affect property tax deduction?',
        answer:
      ...
      {
        question: 'Why are Texas property taxes so high if there is no state income tax?',
        answer:
      ...
      {
        question: 'Can I deduct property tax if I take the standard deduction?',
        answer:
    ...
    datasets: [
      {
        ...
        creator: 'TheTaxCalc, sourced from U.S. Census Bureau ACS 5-year',
        url: `${SITE_URL}/research/property-tax-by-state-2026#effective-rates`,
      },
      {
        name: '2026 Median Annual Property Tax Bills by State',
        description:
          'Median annual property tax payment in current dollars for owner-occupied housing units, for all 50 states plus D.C.',
        creator: 'TheTaxCalc, sourced from U.S. Census Bureau ACS 5-year',
        url: `${SITE_URL}/research/property-tax-by-state-2026#median-bills`,
      },
      {
        name: '2026 County-Level Property Tax Rates — Top 50 Counties',
        description:
          'Effective property tax rate and median bill for the 50 most populous U.S. counties, with state context.',
        creator: 'TheTaxCalc, sourced from Tax Foundation county-level data',
        url: `${SITE_URL}/research/property-tax-by-state-2026#county-data`,
      },
    ],
  },
  {
    ...
    metaTitle: 'Salary Needed to Live Comfortably 2026 — By State',
    metaDescription:
      'How much do you need to earn in 2026 to live comfortably in each state? Using the 50/30/20 rule, regional cost of living, and after-tax paycheck data, we estimate the magic number for all 50 states.',
    ...
    sections: [
      {
        heading: 'Methodology: The 50/30/20 Rule Applied',
        body:
      ...
      {
        heading: 'Top 10 Most Expensive States to Live Comfortably in 2026',
        body:
      ...
      {
        heading: 'Top 10 Most Affordable States to Live Comfortably in 2026',
        body:
      ...
      {
        heading: 'How OBBBA Affects the Calculation',
        body:
      ...
      {
        heading: 'Caveats and Individual Variation',
        body:
    ...
    faqs: [
      {
        question: 'How much do I need to earn to live comfortably in 2026?',
        answer:
      ...
      {
        question: 'How do you calculate the salary needed in each state?',
        answer:
      ...
      {
        question: 'Does the calculation account for the OBBBA tax changes?',
        answer:
      ...
      {
        question: 'Why is Hawaii so much more expensive than other states?',
        answer:
      ...
      {
        question: 'Should I move to a lower-cost state to live more comfortably?',
        answer:
    ...
    datasets: [
      {
        name: '2026 Salary Needed to Live Comfortably — All 50 States',
        description:
        ...
        creator: 'TheTaxCalc, sourced from MIT Living Wage Calculator',
        url: `${SITE_URL}/research/salary-needed-to-live-comfortably-2026#salary-data`,
      },
      {
        name: '2026 Cost of Living Index by State',
        description:
          'Composite cost of living index (U.S. average = 100) covering housing, groceries, utilities, transportation, and healthcare, by state.',
        creator: 'TheTaxCalc, sourced from C2ER',
        url: `${SITE_URL}/research/salary-needed-to-live-comfortably-2026#col-data`,
      },
      {
        name: '2026 After-Tax Income for $75,000 Salary — All 50 States',
        description:
        ...
        creator: 'TheTaxCalc',
        url: `${SITE_URL}/research/salary-needed-to-live-comfortably-2026#after-tax-data`,
      },
    ],
  },
  {
    ...
    sections: [
      {
        heading: 'National Refund Statistics',
        body:
      ...
      {
        heading: 'Average Refund by State',
        body:
      ...
      {
        heading: 'Average Refund by Income Bracket',
        body:
      ...
      {
        heading: 'How OBBBA Is Expected to Change 2026 Refunds',
        body:
      ...
      {
        heading: 'How to Use Refund Statistics',
        body:
    ...
    faqs: [
      ...
      {
        question: 'Which state has the largest average tax refund?',
        answer:
      ...
      {
        question: 'Which income bracket gets the largest refund?',
        answer:
      ...
      {
        question: 'How will OBBBA affect my 2026 refund?',
        answer:
      ...
      {
        question: 'Is a large tax refund good or bad?',
        answer:
      ...
      {
        question: 'When will I get my tax refund in 2026?',
        answer:
    ...
    datasets: [
      {
        name: '2026 Average Federal Tax Refund by State',
        description:
        ...
        creator: 'TheTaxCalc, sourced from IRS Statistics of Income',
        url: `${SITE_URL}/research/tax-refund-statistics-2026#state-data`,
      },
      {
        name: '2026 Average Federal Tax Refund by Income Bracket',
        description:
          'Average federal tax refund for each IRS Statistics of Income AGI bracket, from $0-$25,000 through $1,000,000+.',
        creator: 'TheTaxCalc, sourced from IRS Statistics of Income',
        url: `${SITE_URL}/research/tax-refund-statistics-2026#income-data`,
      },
      {
        name: '2026 OBBBA Refund Impact Projection by Income Quintile',
        description:
        ...
        creator: 'TheTaxCalc, sourced from Tax Foundation',
        url: `${SITE_URL}/research/tax-refund-statistics-2026#obbba-projection`,
      },
    ],
  },
];
  ...
  return (async () => {
    ...
    if (!study) {
      return {
        ...
        description: 'The requested research study could not be found.',
      };
    }
    return {
      title: study.metaTitle,
      description: study.metaDescription,
      alternates: { canonical: `${SITE_URL}/research/${study.slug}` },
      openGraph: {
        title: study.metaTitle,
        description: study.metaDescription,
        url: `${SITE_URL}/research/${study.slug}`,
        siteName: 'TheTaxCalc',
        type: 'article',
        publishedTime: '2026-01-15T08:00:00.000Z',
        authors: ['TheTaxCalc Research Team'],
      },
    };
  })();
}
...
function buildJsonLd(study: Study) {
  return {
    '@context': 'https://schema.org',
    '@graph': [
      {
        '@type': 'BreadcrumbList',
        '@id': `${SITE_URL}/research/${study.slug}#breadcrumb`,
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: study.title,
            item: `${SITE_URL}/research/${study.slug}`,
          },
        ],
      },
      {
        '@type': 'FAQPage',
        '@id': `${SITE_URL}/research/${study.slug}#faq`,
      ...
      },
      {
        ...
        '@id': `${SITE_URL}/research/${study.slug}#article`,
        ...
        keywords: ['tax research', '2026 taxes', study.category.toLowerCase()],
        mainEntityOfPage: {
          '@type': 'WebPage',
          '@id': `${SITE_URL}/research/${study.slug}`,
        },
      },
      ...study.datasets.map((d, i) => ({
        '@type': 'Dataset',
        '@id': `${SITE_URL}/research/${study.slug}#dataset-${i + 1}`,
        name: d.name,
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      >
        ...
        <span aria-hidden="true">/</span>
        <span className="text-foreground font-medium line-clamp-1">{study.title}</span>
      </nav>
      ...
      <header className="mb-10">
        <div className="flex flex-wrap items-center gap-2 mb-4">
          ...
          <span className="text-xs text-muted-foreground">Published {study.date}</span>
      ...
      <section className="mb-10 rounded-xl border border-border/30 bg-card/50 p-6">
        <h2 className="text-2xl font-bold text-foreground mb-4">Datasets Used in This Study</h2>
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          Each dataset below is the underlying data table or source for this study. All datasets
          are licensed under Creative Commons Attribution 4.0 (CC BY 4.0) and are free to reuse
          with attribution to TheTaxCalc.
        </p>
          ...
          {study.datasets.map((dataset) => (
            ...
            >
              ...
              <p className="text-xs text-muted-foreground mt-2">
                Creator: {dataset.creator} · License: CC BY 4.0
              </p>
            </div>
          ))}
        </div>
      ...
      {/* Sources & Methodology */}
      <section className="mb-10 rounded-xl border border-border/30 bg-muted/10 p-6">
        <h2 className="text-2xl font-bold text-foreground mb-4">Sources &amp; Methodology</h2>
        <p className="text-sm text-muted-foreground leading-relaxed mb-3">
          This study uses official government data, including IRS publications (Rev. Proc.
          2025-25, Pub. 15-T, Pub. 972), Social Security Administration data, U.S. Census
          Bureau American Community Survey, the FCC Broadband Deployment Report, and each
          state&rsquo;s Department of Revenue. Tax law changes from the One Big Beautiful Bill
          Act (P.L. 119-1) are incorporated throughout. For full calculation details, see our{' '}
          <Link
            href="/methodology"
        ...
        <p className="text-xs text-muted-foreground">
          Last updated: {study.date}. This study is reviewed annually and updated whenever
          material new data is published by the IRS or other official sources.
        </p>
      </section>
          ...
          {[
            {
              ...
              desc: 'See your after-tax take-home pay for any state.',
            },
            {
              href: '/obbba-tax-calculator',
              title: 'OBBBA Tax Calculator',
              desc: 'Compare 2026 taxes under OBBBA vs prior law.',
            },
            {
              href: '/tax-refund-calculator',
              title: 'Tax Refund Calculator',
              desc: 'Estimate your 2026 federal refund.',
            },
            {
              href: '/compare',
