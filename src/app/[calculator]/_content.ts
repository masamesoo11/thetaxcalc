...
export function getCalculatorContent(type: string): CalculatorContent {
  switch (type) {
    ...
    case 'sales-tax':
      return {
        howItWorks: [
          ...
          'Since the 2018 <a href="https://www.supremecourt.gov/" target="_blank" rel="noopener noreferrer">Supreme Court decision in South Dakota v. Wayfair</a>, states can require online retailers to collect sales tax even without a physical presence. So most online purchases now include sales tax based on your location. Some states also have sales tax holidays — temporary periods where certain items (like back-to-school supplies) are exempt from sales tax.',
        ],
        calculationMethod: {
    ...
    case 'overtime':
      return {
        howItWorks: [
          'Overtime pay is calculated at 1.5x your regular hourly rate for hours worked beyond 40 in a week — that\'s the federal standard under the <a href="https://www.dol.gov/agencies/whd/flsa" target="_blank" rel="noopener noreferrer">Fair Labor Standards Act</a>. So if you make $30/hour, your OT rate is $45/hour. Sounds great until you see the taxes. Overtime is taxed as ordinary income at your marginal federal rate, plus FICA (7.65%), plus state income tax. For someone in the 22% federal bracket in a state like Illinois, the combined hit on OT earnings can approach 35%. That $45/hour OT becomes more like $29/hour after taxes.',
    ...
    case 'irs-withholding':
      return {
        howItWorks: [
          'Your W-4 form tells your employer how much federal tax to withhold from each paycheck. Too much withholding means a big refund but less money in each paycheck. Too little means bigger paychecks but a tax bill — and possibly penalties — in April. This calculator helps you find the sweet spot based on <a href="https://www.irs.gov/publications/p15t" target="_blank" rel="noopener noreferrer">IRS Publication 15-T</a>.',
