...
const PAGE_JSONLD = {
  ...
  '@graph': [
    ...
    { '@id': `${SITE_URL}/home-sale-tax-calculator#webapp`, '@type': 'SoftwareApplication', name: 'Home Sale Tax Calculator', url: `${SITE_URL}/home-sale-tax-calculator`, applicationCategory: 'FinanceApplication', operatingSystem: 'Web', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD', availability: 'https://schema.org/InStock', url: `${SITE_URL}/home-sale-tax-calculator` }, author: { '@id': `${SITE_URL}/home-sale-tax-calculator#author` }, publisher: { '@id': `${SITE_URL}/#organization` } },
