...
const FREEFILE_JSONLD = {
  ...
  '@graph': [
    ...
    { '@id': `${SITE_URL}/freefile-irs#webapp`, '@type': 'SoftwareApplication', name: 'IRS Free File Eligibility Checker', url: `${SITE_URL}/freefile-irs`, applicationCategory: 'FinanceApplication', operatingSystem: 'Web', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD', availability: 'https://schema.org/InStock' }, author: { '@id': `${SITE_URL}/freefile-irs#author` }, publisher: { '@id': `${SITE_URL}/#organization` } },
