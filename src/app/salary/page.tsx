...
const salaryPageJsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description: 'Programmatic salary pages showing after-tax take-home pay for salaries from $30,000 to $500,000 across all 50 states.',
      url: `${SITE_URL}/salary`,
      publisher: { '@id': `${SITE_URL}/#organization` },
        ...
        <section className="py-12 border-t border-border/20">
          <div className="rounded-2xl border border-emerald-500/20 bg-gradient-to-br from-emerald-600/10 to-teal-600/5 p-8 sm:p-12 text-center">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto mb-6">
              ...
              and all 50 states with detailed breakdowns.
            </p>
            <Link
