    ...
    case 'sales-tax':
      return {
        howItWorks: [
          ...
          'Since the 2018 Supreme Court decision in <a href="https://www.supremecourt.gov/opinions/17pdf/17-494_4g15.pdf" target="_blank" rel="noopener noreferrer nofollow">South Dakota v. Wayfair</a>, states can require online retailers to collect sales tax regardless of physical presence. Most online purchases now include sales tax based on the buyer\'s location.',
        ],
        keyRates: [
