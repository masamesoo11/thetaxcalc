    ...
    case 'sales-tax':
      return {
        howItWorks: [
          ...
          'Since the 2018 Supreme Court decision in <a href="https://www.oyez.org/cases/2017/17-494" target="_blank" rel="noopener noreferrer nofollow">South Dakota v. Wayfair</a>, states can require online retailers to collect sales tax regardless of physical presence. Most online purchases now include sales tax based on the buyer\'s location.',
        ],
        keyRates: [
