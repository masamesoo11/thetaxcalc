...
export const BLOG_INDEX: BlogPostMeta[] = [
  ...
  },
  {
    ...
    "excerpt": "Calculate exactly how much tax you'll owe in 2026. Federal brackets, FICA, state taxes, deductions, and credits explained with worked examples for $30K-$250K incomes.",
    "category": "tax-guide",
    "tags": "how much tax will i owe,tax calculator 2026,federal tax brackets,FICA,state income tax,tax liability,tax refund estimator",
    "coverImage": "",
    "published": true,
    "featured": true,
    "metaTitle": "How Much Tax Will I Owe in 2026? Free Calculator Guide",
    "metaDesc": "Calculate your 2026 tax liability step by step. Federal tax, FICA, state tax, deductions, credits. Tables for $30K-$250K incomes in every state.",
