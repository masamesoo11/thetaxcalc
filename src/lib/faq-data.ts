...
export const INCOME_TAX_FAQS: FAQItem[] = [
  ...
  {
    question: 'How much income tax do I pay on $75,000?',
    answer:
  ...
  {
    question: 'Do 401(k) contributions reduce income tax?',
    answer:
...
export const TAX_CALC_FAQS: FAQItem[] = [
  ...
  {
    question: 'What taxes does this calculator include?',
    answer:
  ...
  {
    question: 'How is my tax rate calculated?',
    answer:
  ...
  {
    question: 'Does this calculator work for self-employment income?',
    answer:
  ...
  {
    question: 'When are taxes due for 2026?',
    answer:
...
export const SALES_TAX_FAQS: FAQItem[] = [
  ...
  {
    question: 'How do I calculate the original price from the total?',
    answer:
